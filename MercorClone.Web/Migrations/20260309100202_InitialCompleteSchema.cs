        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncludedAiInterviews = table.Column<int>(type: "integer", nullable: false),
                    FeaturesListJson = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResumeFileUrl = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Currency = table.Column<string>(type: "varchar(10)", nullable: false),
                    HiresTarget = table.Column<int>(type: "integer", nullable: false),
                    JobDescriptionHtml = table.Column<string>(type: "text", nullable: false),
                    RequiredSkills = table.Column<string[]>(type: "text[]", nullable: true),
                    AdditionalRequirements = table.Column<string>(type: "jsonb", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobPosts_AspNetUsers_PostedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AiInterviewsUsedThisMonth = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    AccessedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Publications = table.Column<string>(type: "jsonb", nullable: true),
                    Awards = table.Column<string>(type: "jsonb", nullable: true),
                    SocialLinks = table.Column<string>(type: "jsonb", nullable: true),
                    TotalYearsOfExperience = table.Column<int>(type: "integer", nullable: false),
                    TopSkillsSummary = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    AccessedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CandidateMasteries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CandidateMasteries_CandidateProfiles_CandidateProfileId",
                        column: x => x.CandidateProfileId,
                        principalTable: "CandidateProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AiMatchScore = table.Column<decimal>(type: "numeric(5,2)", nullable: true),
                    AiResumeAnalysisJson = table.Column<string>(type: "jsonb", nullable: true),
                    AiInterviewScheduledAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    AiInterviewVideoUrl = table.Column<string>(type: "varchar(512)", nullable: true),
                    AiInterviewTranscriptJson = table.Column<string>(type: "jsonb", nullable: true),
                    RejectionReason = table.Column<string>(type: "text", nullable: true),
                    RecruiterNotes = table.Column<string>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillingTransactions_StripeInvoiceId",
                table: "BillingTransactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CandidateMasteries_CandidateProfileId",
                table: "CandidateMasteries",
                column: "CandidateProfileId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CandidateProfiles_Country_City",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanySubscriptions_StripeSubscriptionId",
                table: "CompanySubscriptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployerProfiles_UserId_CompanyId",
                table: "EmployerProfiles",
                columns: new[] { "UserId", "CompanyId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_AiMatchScore",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_JobPostId_CandidateProfileId",
                table: "JobApplications",
                columns: new[] { "JobPostId", "CandidateProfileId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_JobPostId_Status",
                table: "JobApplications",
